		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<div class="row list-group-item header" >
						...
						<div class="col-xs-2 col-md-2 ellipsis" title="<?php echo Localization::getString("user.list.userName")?>"><?php echo Localization::getString("user.list.userName")?></div>
						...
						<div class="col-xs-1 col-md-1 ellipsis" title="<?php echo Localization::getString("counter.list.maxValue")?>"><?php echo Localization::getString("counter.list.maxValue")?></div>
			...
			<div class="panel-footer">
				<div class="row">
					<div class="col-md-2 col-md-offset-5 col-xs-2 col-xs-offset-5">
						<button type="button" class="btn btn-info" id="search" title="<?php echo Localization::getString("button.searchRefresh.tooltip")?>" onclick="searchExcedeedCounters()">
