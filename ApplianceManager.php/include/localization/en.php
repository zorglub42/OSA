...
$strings["group.name.tooltip"]="Enter here the group name\n" .
                               ...
                               "Group name is used to manage authentication " .
                               "to services.\n" .
                               "Group name is an identifier and can not be changed.";
...
$strings["user.userName.tooltip"]="Enter here the user name to connect the system\n".
                                  "ATTENTION: do not use special chars\n" .
                                  "User name is an identifier and " .
                                  "can not be changed.";
...
$strings["user.deleteGroup.tooltip"]="Remove user {currentUser.userName} from " .
                                     "group {groupList[i].groupName}";
$strings["user.deleteQuota.tooltip"]="Delete quotas on service " .
                                     "{quotasList[i].serviceName} for " .
                                     "{currentUser.userName}";
$strings["user.editQuota.tooltip"]="Edit quotas on service ".
                                   "{quotasList[i].serviceName} for " .
                                   "{currentUser.userName}";
$strings["user.quotas.serviceName.tooltip"]="Select service to define user quotas";
$strings["user.quotas.reqSec.tooltip"]="Enter here the maximum of number ".
                                       "of request per sercond allowed for the " .
                                       "user on this service.";
$strings["user.quotas.reqDay.tooltip"]="Enter here the maximum of number of " .
                                       "request per day allowed for the user on " .
                                       "this service.";
$strings["user.quotas.reqMonth.tooltip"]="Enter here the maximum of number of " .
                                         "request per month allowed for the user ".
                                         "on this service.";
...
$strings["user.deleteGroup.confirm"]="Do you really want to remove this user ".
                                     "from group";
...
$strings["user.quotas.edit"]="Edit service {quota.serviceName} quotas for user " .
                             "{quota.userName}";
...
$strings["service.loginForm.placeholder"]="Ex.: " .
                                           "/ApplianceManagerAdmin/auth/loginFom";
...
$strings["service.name.tooltip"]="Enter here service name\n".
                                 ...
                                 "can not be changed.";
$strings["service.frontendEndpoint.tooltip"]="Enter here the public alias for " .
                                             "this service\nEx: /myservice";
$strings["service.backendEndpoint.tooltip"]="Enter here the service URL on " .
                                            "backend system\n" .
                                            " Ex: http://backend.server/myservice\n".
                                            "OSA supports http, https and, " .
                                            "if apache2.4 or more, " .
                                            "also supports ws and wss";
...
$strings["service.isPublished.tooltip"]="If this box is checked, this service " .
                                        "will be publihed on nodes\n" .
                                        "else it's not available"; 
$strings["service.group.tooltip"]="To use the service, users have to be members of ".
                                  "selected group";
$strings["service.loginForm.tooltip"]="If the publication node support cookie " .
                                      "authentication, unauthenticated access will ".
                                      "be redirected to this URL";
$strings["service.isAnonymousAllowed.tooltip"]="Unauthenticated can also acces " .
                                               "to this service.\n".
                                               "In this case, backend system have ".
                                               "to check if and identity is ".
                                               "forwarded (connected user) or if ".
                                               "it's empty (anonymous)";
$strings["service.forwardIdentity.tooltip"]="If this box is checked, connected " .
                                            "user identity will be forwarded as ".
                                            "an HTTP header to the backend server";
$strings["service.baUsername.tooltip"]="User name to authenticate against backend ".
                                       "(basic auth.)\n".
                                       "Use %auto% to authenticate with same ".
                                       "credential as those received by OSA";
$strings["service.baPassword.tooltip"]="Password to authenticate against backend";
$strings["service.isGlobalQuotasEnabled.tooltip"]="If this box is checked, ".
                                                  "backend system access will ".
                                                  "be limited by global quotas ".
                                                  "(what ever who's the user)";
...
$strings["service.isUserQuotasEnabled.tooltip"]="If this box is checked, ".
                                                "backend system access will be ".
                                                "limited by per user quotas";
$strings["service.onAllNodes.tooltip"]="If this box is checked, this service ".
                                       "will be published on all available nodes";
$strings["service.publishedOnNodes.tooltip"]="Select (with CTRL+Click) nodes on ".
                                             "whitch {serviceName} will be " .
                                             "published";
$strings["service.logHits.tooltip"]="If this box is checked, hits to this ".
                                    "service will be recorded in logs\n".
...
$strings["service.label.additionalConfiguration.helpText"]
    ="In addition to standard apache environnement variable, in link with the way ".
     "used by the node to published this service, you can use here:\n" .
                        "<ul>\n" .
                        "	<li>\n" .
                        "		%{publicServerProtocol}e for protocol used ".
                                "(i.e http:// or https://)\n" .
                        "	</li>\n" .
                        "	<li>\n" .
                        ...
                        "	</li>\n" .
                        "	<li>\n" .
                        "		%{publicServerPrefix}e concatenation of previous ".
                                "variables ".
...
$strings["node.deleteCASSL.confirm"]
    ="Do you really want to remove CA and chain data?";
...
$strings["node.nodeName.tooltip"]
    ="Enter here node name\nnATTENTION: do not use special chars\n".
     "Node name is an identifier and can not be changed.";
$strings["node.isHTTPS.tooltip"]
    ="If this box is checked, thios node will be avaible with HTTPS, ".
     "else, with HTTP";
$strings["node.localIP.tooltip"]
    ="Enter here IP or hotname on which node is listening (or * for all)";
$strings["node.port.tooltip"]
    ="Enter here TCP port on which node is listening";
$strings["node.serverFQDN.tooltip"]
    ="Enter here server FQDN (VirtualHost ServerName)";
$strings["node.nodeDescription.tooltip"]="Node description (optional)";
$strings["node.isBasicAuthEnabled.tooltip"]
    ="If this box is checked, services publshed on this node will be protected ".
     "by HTTP basic authentication mode";
$strings["node.isCookieAuthEnabled.tooltip"]
    ="If this box is checked, services publshed on this node will be protected ".
     "by HTTP cookie mode";
$strings["node.privateKey.tooltip"]
    ="Select a file containing server private key. If you don't select any file, ".
     "a key will be generated by the system";
$strings["node.cert.tooltip"]
    ="Select file containing server certificate. If you don't select any file, ".
     "a certificate will be generated by the system";
$strings["node.manageCA.tooltip"]
    ="Check this bow to specify CA and certification chain data";
$strings["node.ca.tooltip"]="Select a file containing CA cert.";
$strings["node.chain.tootip"]
    ="Select a file containing certification chain certificates.";
$strings["node.additionalConfiguration.tooltip"]
    ="You can add here any appache directive applicable to </VirtualHost> tag";
$strings["node.publish.tooltip"]="Start ths node";
$strings["node.unpublish.tooltip"]="Stop this node";
$strings["node.https-on-80-warning"]
    ="ATTENTION: Using HTTPS on port 80 (and not HTTP) may cause problems...\n".
     "Do you really want to do that?";
$strings["node.http-on-443-warning"]
    ="ATTENTION: Using HTTP on port 443 (and not HTTPS) may cause problems...\n".
     "Do you really want to do that?";
$strings["node.no-authent-warning"]
    ="At least one authentication methode (basic authentication or cookie ".
...
$strings["log.execute.confirm"]
    ="Execute a request without criterais may be long and and dramatically ".
     "affect gataway performances.\nContitnue anyway?";
    /*Labels*/
