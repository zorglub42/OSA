...
function deleteNode(a,b){confirm("ZZOPEN echo Localization::getJSString(QUOTEnode.delete.confirmQUOTE)ZZCLOSE "+b+"?")&&(showWait(),$.ajax({url:a,dataType:"json",type:"DELETE",success:showNodes,error:displayErrorV2}))}function resetNodeFilter(){$("#nodeNameFilter").val("");$("#nodeDescriptionFilter").val("");$("#localIPFilter").val("");$("#portFilter").val("");$("#serverFQDNFilter").val("");showNodes()}
