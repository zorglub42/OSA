...
0==fetchingMore&&""!=nextFetch&&(fetchingMore=1,showWait(),$.ajax({url:nextFetch,dataType:"json",type:"GET",success:addFetch,error:displayError}))});touchScroll("data")})}function addFetch(a){hideWait();fetchingMore=0;nextFetch=a.next;previousFetch=a.previous;$("#logsCount").html(a.length+" hits found");generateLogsTableRows(a.logs)}function startPopulateAutoCompleteServices(){$.getJSON("services/?withLog=1&order=serviceName",populatePopulateAutoCompleteServices).error(displayError)}
