var logSearch_userName="",logSearch_serviceName="",logSearch_status="",logSearch_message="",logSearch_from="",logSearch_until="",logSearch_frontEndEndPoint="",logRegExComp="\n(may include * for any string)",logServiceNameToolTip="Choose the service for which you want to find logs or leave empty for any."+logRegExComp,logUserNameToolTip="Choose the user for which you want to find logs or leaves empty for any."+logRegExComp,logHTTPStatusToolTip="Enter the HTTP Status of the response send to consumer for which you want to find logs or leave empty for any.",
logFromToolTip="Enter the date/time from which logs where recorded or leave empty for any.",logUntilToolTip="Enter date/time until which logs where recorded. Leave empty for any.",logMessageToolTip="Enter the error message returned to consumer. Leave empty for any"+logRegExComp,logFrontEndEndPointToolTip="Enter the frontend URL prefix. Leave empty for any"+logRegExComp,logRowPattern=null,nextFetch="",previousFetch="",fetchingMore=0;
function resetSearchLogs(){logSearch_frontEndEndPoint=logSearch_until=logSearch_from=logSearch_message=logSearch_status=logSearch_serviceName=logSearch_userName="";searchLogs()}
...
go=!0;""==queryString&&(go=confirm("ZZOPEN echo Localization::getJSString(QUOTElog.execute.confirmQUOTE)ZZCLOSE"));go&&(""!=queryString&&(queryString+="&"),queryString+="order="+encodeURIComponent("timeStamp desc"),showWait(),$.ajax({url:"logs/?"+queryString,dataType:"json",type:"GET",success:displayLogsList,error:displayError}))}
