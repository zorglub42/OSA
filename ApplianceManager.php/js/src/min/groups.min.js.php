...
function deleteGroup(a,b){confirm("<?php echo Localization::getJSString("group.delete.confirm")?> "+b+"?")&&$.ajax({url:a,dataType:"json",type:"DELETE",success:showGroups,error:displayErrorV2})}
