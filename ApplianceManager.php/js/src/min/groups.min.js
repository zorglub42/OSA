ZZOPEN;ZZCLOSE;var groupModified,groupNameFilterPrevVal="",groupDescritpionFilterPrevVal="",currentGroup;function resetGroupFilter(){groupDescritpionFilterPrevVal=groupNameFilterPrevVal="";$("#groupNameFilter").val("");$("#groupDescritpionFilter").val("");showGroups()}function handelGroupFilterFormKeypress(a){if(13==a.keyCode)return showGroups(),!1}
