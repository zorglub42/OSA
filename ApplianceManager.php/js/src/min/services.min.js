...
function deleteService(a,c){confirm("ZZOPEN echo Localization::getJSString(QUOTEservice.delete.confirmQUOTE)ZZCLOSE "+c+"?")&&(showWait(),$.ajax({url:a,dataType:"json",type:"DELETE",success:showServices,error:displayErrorV2}))}function resetServiceFilter(){$("#serviceNameFilter").val("");$("#serviceGroupNameFilter").val("");$("#frontEndEndPointFilter").val("");$("#backEndEndPointFilter").val("");showServices()}
