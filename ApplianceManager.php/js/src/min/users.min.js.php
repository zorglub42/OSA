...
function editUser(a){$.get("resources/templates/userEdit.php",function(b){userDate=new Date(a.endDate);dateFormated=userDate.format("<?php echo Localization::getJSString("date.format")?>");currentUser=a;$("#content").html(b.replaceAll("{userNameAsLabel}",a.userName).replaceAll("{userNameInputType}","hidden").replaceAll("{userNameToolTip}",userNameToolTip).replaceAll("{editUserGroupsToolTip}",editUserGroupsToolTip).replaceAll("{editUserQuotasToolTip}",editUserQuotasToolTip).replaceAll("{passwordToolTip}",
