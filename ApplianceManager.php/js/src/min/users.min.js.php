...
function saveOrUpdateUser(a){if(!addUserProperty())return!1;currentUserUri="users/"+encodeURIComponent(document.getElementById("userName").value);password="password="+encodeURIComponent(document.getElementById("userPass").value);userName="userName="+encodeURIComponent(document.getElementById("userName").value);email="email="+encodeURIComponent(document.getElementById("userMail").value);firstName="firstName="+encodeURIComponent(document.getElementById("firstName").value);lastName="lastName="+encodeURIComponent(document.getElementById("lastName").value);
entity="entity="+encodeURIComponent(document.getElementById("entity").value);try{d=Date.parseExact(document.getElementById("userEndDate").value,"<?php echo Localization::getJSString("date.format.parseexact")?>"),d.setHours(12),endDate="endDate="+encodeURIComponent(d.format("isoUtcDateTime"))}catch(b){endDate="endDate="}user={userName:$("#userName").val(),password:$("#userPass").val(),email:$("#userMail").val(),firstName:$("#firstName").val(),lastName:$("#lastName").val(),entity:$("#entity").val(),
