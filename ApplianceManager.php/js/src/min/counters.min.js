ZZOPEN;ZZCLOSE;var currentCounter,counterModified,counterSearch_resourceName,counterSearch_userName,counterSearch_timeUnit,currentCounterList,backList;function setCounterModified(a){(counterModified=a)?setActionButtonEnabled("save",!0):setActionButtonEnabled("save",!1)}function updateCounter(a){saveOrUpdateCounter("PUT")}
...
function startSearchCounters(){counterSearch_userName=document.getElementById("userName").value;counterSearch_resourceName=document.getElementById("resourceName").value;counterSearch_timeUnit=document.getElementById("timeUnit").value;executeSearch()}
