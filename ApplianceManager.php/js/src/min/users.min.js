...
function saveOrUpdateUser(a){if(!addUserProperty())return!1;currentUserUri="users/"+encodeURIComponent(document.getElementById("userName").value);try{d=Date.parseExact(document.getElementById("userEndDate").value,"ZZOPEN echo Localization::getJSString(QUOTEdate.format.parseexactQUOTE)ZZCLOSE"),d.setHours(12),endDate=d.format("isoUtcDateTime")}catch(b){endDate=""}user={userName:$("#userName").val(),password:$("#userPass").val(),email:$("#userMail").val(),firstName:$("#firstName").val(),lastName:$("#lastName").val(),
