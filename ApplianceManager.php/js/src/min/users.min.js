...
a[i].emailAddress).replaceAll("{userList[i].uri}",a[i].uri).replaceAll("{userList[i].endDate}",h.format("ZZOPEN echo Localization::getJSString(QUOTEdate.formatQUOTE)ZZCLOSE"));table.appendChild(newRow);edit=document.getElementById("btnEdit");del=document.getElementById("btnDelete");"Admin"===a[i].userName?del.remove():del.removeAttribute("id");edit.removeAttribute("id")}0==a.length&&$("#usersList").hide();$("#userNameFilter").autocomplete({source:b,minLength:0});$("#emailAddressFilter").autocomplete({source:c,
