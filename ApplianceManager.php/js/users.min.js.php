...
a[i].emailAddress).replaceAll("{userList[i].uri}",a[i].uri).replaceAll("{userList[i].endDate}",h.format("<?php echo Localization::getJSString("date.format")?>"));table.appendChild(newRow);edit=document.getElementById("btnEdit");del=document.getElementById("btnDelete");"Admin"===a[i].userName?del.remove():del.removeAttribute("id");edit.removeAttribute("id")}0==a.length&&$("#usersList").hide();$("#userNameFilter").autocomplete({source:b,minLength:0});$("#emailAddressFilter").autocomplete({source:c,
