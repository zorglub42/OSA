...
function deleteUserGroup(a,b,c){confirm("<?php echo Localization::getJSString("user.deleteGroup.confirm")?> "+b+"?")&&$.ajax({url:c+"/"+a,dataType:"json",type:"DELETE",success:startDisplayUserGroupsForCurrentUser,error:displayErrorV2})}
