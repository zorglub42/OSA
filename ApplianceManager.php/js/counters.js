...
function editCounter(counter){
	...
	$.get("resources/templates/counterEdit.html", function(data){
...
function displayCounterList(counterList){
	...
	$.get( "resources/templates/counterList.html", function( data ) {
...
function displayExcedeedCounterList(counterList){
	...
	$.get( "resources/templates/counterExceededList.html", function( data ) {
...
function searchCounters(){
	...
	$.get("resources/templates/counterSearch.html", function(data){
		$("#content").html(data.replaceAll("{resourceNameToolTip}", resourceNameToolTip)
							   .replaceAll("{userNameToolTip}", userNameToolTip)
							   .replaceAll("{timeUnitToolTip}", timeUnitToolTip)
		);
