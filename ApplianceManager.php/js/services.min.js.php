...
function startEditService(a){$.getJSON(a,editService).error(displayErrorV2)}function startPopulateGroups(){$.getJSON("groups/",populateGroups).error(displayErrorV2)}function populateGroups(a){$.each(a,function(a,b){$("#groupName").append($("<option>",{value:b.groupName,text:""!=b.description?b.description:b.groupName}))});""!=currentServiceGroupName&&$("#groupName option[value="+currentServiceGroupName+"]").prop("selected","selected")}function updateService(a){saveOrUpdateService("PUT")}
