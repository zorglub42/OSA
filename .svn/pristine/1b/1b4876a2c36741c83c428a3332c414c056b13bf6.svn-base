...
class XmlFormat implements iFormat
{
	...
	$human_readable=false, &$xml=null) {
		...
		if (is_null($xml))
		$xml = @simplexml_load_string("<$root_node_name xmlns=\"http://nursery.orange.com/appliance/V2\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xsi:schemaLocation=\"http://nursery.orange.com/appliance/V2 applianceV2.xsd\"/>");
		if(is_array($data)){
			$numeric=0;
